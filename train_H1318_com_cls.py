...
from ImageDataset_MDGTnet_H1318_com_cls import ImgDataset_train
...
# load train data H13 or H18
img_1 = np.load("data/MDGTnet_H1318/gen_H13/img_norm_all.npy")
img_1 = torch.from_numpy(img_1).float()
img_2 = np.load("data/MDGTnet_H1318/gen_H18/img_norm_all.npy")
img_2 = torch.from_numpy(img_2).float()
label_1 = np.load("data/MDGTnet_H1318/gen_H13/gt_norm_all.npy")
label_2 = np.load("data/MDGTnet_H1318/gen_H18/gt_norm_all.npy")
...
for epoch in range(num_epoch):
    ...
    torch.save(model.state_dict(), './models/MDGTnet_H1318/model{}.pth'.format(epoch))
